...
<li class="dropdown">
    ...
    <ul class="dropdown-menu" style="width: 30px !important;">
        <li><a href="#" class="auto-refresh-trigger" data-interval=2>2s</a></li>
        <li><a href="#" class="auto-refresh-trigger" data-interval=5>5s</a></li>
        <li><a href="#" class="auto-refresh-trigger" data-interval=10>10s</a></li>
        <li><a href="#" class="auto-refresh-trigger" data-interval=30>30s</a></li>
        <li><a href="#" class="auto-refresh-trigger" data-interval=60>1min</a></li>
    </ul>
</li>
